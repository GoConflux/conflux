...
var AddonGrid = React.createClass({
  ...
  confluxLogo: function () {
    return !!this.props.home || !!this.props.explore ? 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/conflux-long-white-colored-icon.svg' : 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/conflux-long-colored.svg';
  },
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'a',
          { href: '/' },
          React.createElement('img', { className: 'lh-logo', src: this.confluxLogo() })
        )
      ),
      React.createElement(
        'div',
