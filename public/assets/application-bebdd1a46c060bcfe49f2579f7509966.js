...
var AddonGrid = React.createClass({
  ...
  headlineFeatures: ['Read/Write access to Non-production apps', 'Read access to Production apps', 'Write access to Production apps', 'Can invite new team members'],
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'modal-name-input-container', ref: this.setInputContainerRef },
        React.createElement('input', { type: 'text', className: 'modal-name-input', placeholder: 'Email', onKeyUp: this.onKeyUp, ref: this.setInputRef })
      ),
  ...
  getActionIcons: function () {
    ...
    return React.createElement(
      ...
      React.createElement('i', { className: 'fa fa-pencil edit' }),
  ...
  getUsers: function () {
    ...
    return this.state.users.map(function (user) {
      return React.createElement(
        "li",
        null,
        React.createElement(TeamUser, { data: user, cuCanEdit: self.props.cuCanEdit })
      );
    });
  },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(TeamUsersList, { users: this.props.users, cuCanEdit: this.props.cu_can_edit, ref: this.setTeamUsersListRef })
    );
  }
