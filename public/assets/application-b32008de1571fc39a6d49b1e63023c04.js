...
var AddonGrid = React.createClass({
  ...
  render: function () {
    return React.createElement("div", { id: "landingFooter" });
  }
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { id: 'menuFooter' },
        React.createElement(Dropdown, { customID: 'teamSettingsDropdown', data: this.getSettingsDropdownOptions(), ref: this.setDropdownRef }),
        React.createElement(
          'a',
  ...
  getAddMembersBtn: function () {
    return this.props.cu_can_invite ? React.createElement(
      'div',
