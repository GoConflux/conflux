...
var AddonGrid = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'a',
          { href: '#', className: teamSettingsBtnClasses },
          React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/gear-white.svg' })
        ),
        React.createElement(
          'a',
          { href: this.props.link + '/users', className: usersBtnClasses },
          React.createElement('i', { className: 'fa fa-users' })
        ),
        React.createElement(
          'a',
          { href: 'javascript:void(0)', onClick: this.onFeedbackClick, className: 'menu-footer-link' },
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(ModalNameInput, { placeholder: 'Team name', onKeyUp: this.onNameInputKeyUp, ref: this.setNameInputRef })
    );
  }
  ...
  getCurrentModal: function () {
    return ({
      'team:create': {
        body: React.createElement(CreateTeamModal, { data: this.data, ref: this.setCurrentModal }),
