  ...
  render: function () {
    if (this.props.data.isNew) {
      return React.createElement(
        'div',
        null,
        React.createElement('input', { type: 'text', className: 'key-name-input config-var-input new', placeholder: 'KEY' }),
        React.createElement('input', { type: 'text', className: 'key-val-input config-var-input', placeholder: 'VALUE' }),
        React.createElement(
          'a',
      ...
      return React.createElement(
        'div',
        null,
        React.createElement('i', { className: 'fa fa-info-circle key-info-icon' }),
