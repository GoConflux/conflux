...
var AddonGrid = React.createClass({
  ...
  render: function () {
    if (this.props.data.isNew) {
      ...
      return React.createElement(
        ...
        React.createElement('i', { onClick: this.onClickEdit, className: 'fa fa-pencil edit-icon' }),
        React.createElement('i', { onClick: this.onClickRemove, className: 'fa fa-times remove-key-icon' })
      );
    }
  }
  ...
  formatConfigVars: function () {
    ...
    var configs = this.state.keys.map(function (key, i) {
      return React.createElement(
        'li',
        null,
        React.createElement(ConfigVar, { onUpdateKeys: self.onUpdateKeys, data: key })
      );
    });
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(InAppSearchBar, { onAddonSelected: this.onAddonSelected })
    );
  }
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'app-addon-body' },
        React.createElement(
          'div',
          { className: 'config-vars-container' },
          React.createElement(ConfigVars, { data: this.props })
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            ...
            React.createElement(Plans, { data: this.props.plan_data, onPlanSelected: this.onPlanSelected, ref: this.setPlanRef })
          ),
          React.createElement(
            'div',
  ...
  formatTiers: function () {
    ...
    return this.props.tiers.reverse().map(function (tier) {
      return React.createElement(
        'li',
        null,
        React.createElement(Tier, { tierUUIDs: self.tierUUIDs, data: tier, ref: self.addTierToTiersMap })
      );
    });
  },
