...
var AddonGrid = React.createClass({
  ...
  render: function () {
    return React.createElement(
      "div",
      { className: "modal-titled-input-container" },
      React.createElement(
        "div",
        { className: "select-title" },
        this.props.titleText
      ),
      React.createElement("input", { key: Date.now(), type: "text", className: "modal-titled-input", placeholder: this.props.placeholder, defaultValue: this.getDefaultValue(), ref: this.setInputRef })
    );
  }
