    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'a',
          { href: '/' },
          React.createElement('img', { className: 'lh-logo', src: this.confluxLogo(), ref: this.setLogoRef })
        )
      ),
      React.createElement(
        'div',
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'subtitle' },
          'Addons are self-hosted, third-party services, ready to be integrated with your app in one command. They provide services for caching, persistence, email, messaging, and more.'
        )
      ),
      React.createElement(
        'div',
