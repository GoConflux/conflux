  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("img", { src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/conflux-icon-gray.svg", className: "conflux-icon" }),
        React.createElement(
          "div",
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('img', { onClick: this.toggleDropdown, src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/gear.png', className: 'settings-icon' }),
