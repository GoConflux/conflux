...
var AddonGrid = React.createClass({
  ...
  formatAddons: function () {
    if (this.state.addons.length == 0) {
      return this.props.writeAccess ? React.createElement(
        "div",
        { className: "no-addons-view" },
        "This app doesn't have any add-ons yet.",
      ...
      return this.state.addons.map(function (addon) {
        return React.createElement(
          ...
          React.createElement(Addon, { data: addon })
        );
      });
    }
  },
  ...
  displayName: "AddonModalTop",

  render: function () {
    return React.createElement(
      "div",
      { className: "addon-modal-top-container" },
      React.createElement("img", { src: this.props.data.icon, className: "modal-top-addon-icon" }),
      React.createElement(
        "div",
        { className: "modal-top-addon-name" },
  ...
  render: function () {
    return React.createElement(
      "a",
      { href: this.props.data.link, className: "addon" },
      React.createElement("img", { src: this.props.data.icon, className: "addon-icon" }),
      React.createElement(
        "div",
  ...
  onNewKeyBlur: function () {
    ...
    setTimeout(function () {
      if (!$(self.keyName).is(':focus') && !$(self.keyValue).is(':focus') && !$(self.newKeyDescription).is(':focus') && _.isEmpty($(self.keyName).val().trim()) && _.isEmpty($(self.keyValue).val().trim())) {
  ...
  getEditIcon: function () {
    ...
    return React.createElement('i', { onClick: this.onClickEdit, className: 'fa fa-pencil edit-icon' });
  },
  ...
  getRemoveIcon: function () {
    ...
    return React.createElement('i', { onClick: this.onClickRemove, className: 'fa fa-times remove-key-icon' });
  },
  ...
  render: function () {
    if (this.props.data.isNew) {
      return React.createElement(
        'div',
        { key: Math.random(), className: 'relative' },
        React.createElement('input', { onFocus: this.onNewKeyFocus, onBlur: this.onNewKeyBlur, ref: this.setKeyNameRef, type: 'text', className: 'key-name-input config-var-input new', placeholder: 'KEY' }),
        React.createElement('input', { onFocus: this.onNewKeyFocus, onBlur: this.onNewKeyBlur, ref: this.setKeyValueRef, type: 'text', className: 'key-val-input config-var-input', placeholder: 'VALUE' }),
        React.createElement('input', { onBlur: this.onNewKeyBlur, className: 'new-config-description config-var-input', type: 'text', placeholder: 'Description', ref: this.setDescriptionRef }),
        React.createElement(
          'a',
          { href: 'javascript:void(0)', onClick: this.props.onAddNewKey, className: 'add-new-key-btn' },
          'Add'
        )
      );
    } else {
      return React.createElement(
        'div',
        { key: Math.random() },
        React.createElement('i', { className: 'fa fa-info-circle key-info-icon', 'data-toggle': 'tooltip', 'data-placement': 'left', title: this.description() }),
        React.createElement('input', { type: 'text', className: 'key-name-input config-var-input', placeholder: 'KEY', value: this.props.data.name, disabled: 'disabled' }),
        React.createElement('input', { type: 'text', className: 'key-val-input config-var-input', placeholder: 'VALUE', value: this.props.data.value, disabled: 'disabled' }),
        this.getEditIcon(),
        this.getRemoveIcon()
      );
    }
  ...
  formatConfigVars: function () {
    ...
    var configs = this.state.keys.map(function (key, i) {
      return React.createElement(
        'li',
        null,
        React.createElement(ConfigVar, { onUpdateKeys: self.onUpdateKeys, writeAccess: self.props.writeAccess, data: key })
      );
    });

    if (this.props.writeAccess) {
      configs.push(React.createElement(
        'li',
        { className: 'new' },
        React.createElement(ConfigVar, { data: { isNew: true }, onAddNewKey: this.onAddNewKey })
      ));
    }
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'app-addon-subsection-title' },
        'Config Vars'
      ),
      React.createElement(
        'ul',
        { className: 'config-vars-list' },
        this.formatConfigVars()
      )
    );
  }
  ...
  formatPlans: function () {
    ...
    return this.props.data.plans.map(function (plan, i) {
      ...
      return React.createElement(
        'li',
        { className: classes, 'data-plan-index': i, onClick: self.props.onPlanSelected },
        React.createElement(
          'div',
          { className: 'name' },
          plan.name
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'ul',
        { className: this.getPlansListClasses() },
        this.formatPlans()
      )
    );
  }
  ...
  getSearchBar: function () {
    if (this.props.data.write_access) {
      return React.createElement(InAppSearchBar, { onAddonSelected: this.onAddonSelected });
    } else {
  ...
  render: function () {
    return React.createElement(
      'div',
      { id: 'appHeader', key: Date.now() },
      React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/app-gray.svg', className: 'app-header-icon' }),
      React.createElement(
        'div',
        { className: 'left-header-title' },
        this.state.name
      ),
      React.createElement('div', { className: 'header-linebreak' }),
      this.getSearchBar()
    );
  }
});var AppListItem = React.createClass({
  displayName: "AppListItem",

  render: function () {
    return React.createElement(
      "div",
      { className: "app-list-item" },
      React.createElement("img", { src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/app-gray.svg", className: "app-icon" }),
      React.createElement(
        "div",
        { className: "app-name" },
        this.props.data.name
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(AppAddon, null),
      React.createElement(PageDNE, null),
      React.createElement(NoPipelines, null)
    );
  }
});var CategoryAddonsGrid = React.createClass({
  displayName: "CategoryAddonsGrid",
  ...
  getCategories: function () {
    return this.state.addons.map(function (group) {
      ...
      return React.createElement(
        "div",
        { className: "category", "data-category": group[0].toLowerCase() },
        React.createElement(
          "div",
          { className: "category-name" },
          category
        ),
        React.createElement(CategoryAddonsGrid, { data: addons })
      );
    });
  },
  ...
  getTeamIcon: function (team) {
    ...
    if (team.icon) {
      el = React.createElement('div', { className: 'team-icon', style: { backgroundImage: "url('" + team.icon + "')" } });
    } else {
      el = React.createElement(
        'div',
        { className: 'team-icon no-icon' },
  ...
  getMenuItems: function () {
    ...
    var items = (this.props.teams || []).map(function (team) {
      return React.createElement(
        'a',
        { className: 'header-team-menu-item-link', href: team.url },
        React.createElement(
          'li',
          { className: 'header-team-menu-item' },
          self.getTeamIcon(team),
          React.createElement(
            'div',
            { className: 'header-team-name' },
            team.name
          )
        )
      );
    ...
    if (items.length === 0) {
      items.push(React.createElement(
        'li',
        { className: 'header-team-menu-no-teams' },
        'No teams yet.',
        React.createElement('br', null),
    ...
    items.push(React.createElement('li', { className: 'header-team-menu-divider' }));
    items.push(React.createElement(
      'a',
      { className: 'header-team-menu-item-link non-team', onClick: this.promptNewTeam, href: 'javascript:void(0)' },
      React.createElement(
        'li',
        { className: 'header-team-menu-item' },
        React.createElement(
    ...
    items.push(React.createElement(
      'a',
      { className: 'header-team-menu-item-link non-team', onClick: this.signOut, href: 'javascript:void(0)' },
      React.createElement(
        'li',
        { className: 'header-team-menu-item' },
        React.createElement(
  ...
  render: function () {
    return React.createElement(
      'div',
      { id: 'headerTeamMenu', className: this.getMenuClasses(), ref: this.setHeaderMenuRef },
      React.createElement(
        'div',
        { id: 'menuItemsScrollContainer' },
        React.createElement(
          'ul',
          { id: 'headerTeamMenuList' },
          this.getMenuItems()
        )
      )
    );
  ...
  configureBackBtn: function () {
    if (this.props.back_url) {
      return React.createElement(
        "a",
        { className: "header-back-btn", onClick: this.onBackClick, href: this.props.back_url },
        React.createElement("i", { className: "fa fa-angle-left header-back-btn-icon" }),
        React.createElement(
          "div",
          { className: "header-back-btn-text" },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("i", { className: "fa fa-bars", id: "headerMenuBtn" }),
        React.createElement(
          "a",
          { href: "/" },
          React.createElement("img", { src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/conflux-icon-dark.svg", className: "conflux-icon" })
        ),
        React.createElement(
          "div",
          { id: "lh-teams-button", className: "dark" },
          React.createElement("i", { className: "fa fa-th-large teams-grid-icon" }),
          React.createElement(
            "div",
        ...
        React.createElement(
          "div",
          { className: "header-right header-right-text-btn" },
          React.createElement(
            "a",
            { className: "header-action-btn", href: "/explore" },
            "Explore"
          )
        ),
        React.createElement(
          ...
          React.createElement(
            "a",
            { className: "header-action-btn", href: "/toolbelt" },
            "Toolbelt"
          )
        )
      )
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "footer-left footer-section" },
          React.createElement(
            "a",
            { href: "/" },
            React.createElement("img", { className: "footer-icon", src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/conflux-icon-footer.svg" })
          )
        ),
        React.createElement(
          "div",
          { className: "footer-middle footer-section" },
          React.createElement(
            "div",
        ...
        React.createElement(
          "div",
          { className: "footer-right footer-section" },
          React.createElement(
            "a",
            { href: "mailto:team@goconflux.com", className: "footer-action-link" },
            "Contact Us"
          )
        )
      )
  ...
  getRightestButton: function () {
    ...
    if (!!this.props.authed) {
      ...
      button = React.createElement(
        'div',
        { className: 'lh-right-button' },
        React.createElement(
          'a',
          { className: 'lh-right-link', href: '/login' },
          'Sign In'
        )
      );
    }
  ...
  render: function () {
    return React.createElement(
      'div',
      { id: 'landingHeader', className: this.landingHeaderClass() },
      React.createElement(
        'div',
        { className: 'lh-left' },
        React.createElement(
          'a',
          { href: '/' },
          React.createElement('img', { className: 'lh-logo' })
        )
      ),
      React.createElement(
        'div',
        ...
        React.createElement(
          ...
          React.createElement(
            'a',
            { className: this.getExploreClasses(), href: '/explore' },
            'Explore'
          )
        ),
        React.createElement(
          ...
          React.createElement(
            'a',
            { className: this.getToolbeltClasses(), href: '/toolbelt' },
            'Toolbelt'
          )
        )
      )
  ...
  formatPipelines: function () {
    if (this.state.pipelines.length == 0) {
      return React.createElement(
        'div',
        { className: 'no-pipelines-menu-message' },
        'No Pipelines'
      );
    } else {
      return this.state.pipelines.map(function (pipeline) {
        ...
        return React.createElement(
          'a',
          { href: pipeline.link, className: classes },
          React.createElement(
            'li',
            { key: pipeline.name, className: 'menu-pipeline' },
            React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/pipeline-white.svg' }),
            React.createElement(
              'div',
  ...
  getMenuTeamIcon: function () {
    ...
    if (this.props.icon) {
      el = React.createElement('div', { id: 'menuTeamIcon', style: { backgroundImage: "url('" + this.props.icon + "')" } });
    } else {
      el = React.createElement(
        'div',
        { id: 'menuTeamIcon', className: 'no-icon' },
  ...
  getTeamSettingsDropdown: function () {
    ...
    return React.createElement(Dropdown, { customID: 'teamSettingsDropdown', data: this.getSettingsDropdownOptions(), ref: this.setDropdownRef });
  },
  ...
  getTeamSettingsBtn: function () {
    ...
    return React.createElement(
      'a',
      { href: 'javascript:void(0)', className: 'menu-footer-link', 'data-action': 'settings' },
      React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/gear-white.svg' })
    );
  },
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('i', { className: 'fa fa-angle-left slide-menu-back-icon', onClick: this.hideMenu })
        )
      ),
      React.createElement(
        'div',
        ...
        React.createElement(
          ...
          React.createElement(
            'ul',
            { id: 'menuPipelinesList' },
            this.formatPipelines()
          )
        )
      ),
      React.createElement(
        ...
        React.createElement(
          'a',
          { href: this.props.link + '/users', className: usersBtnClasses, 'data-action': 'users' },
          React.createElement('i', { className: 'fa fa-users' })
        ),
        React.createElement(
          'a',
          { href: 'javascript:void(0)', onClick: this.onFeedbackClick, className: 'menu-footer-link', 'data-action': 'feedback' },
  ...
  displayName: "DeleteAddonModal",

  render: function () {
    return React.createElement(
      "div",
      { className: "delete-addon-modal-container" },
      React.createElement(
        "div",
        { className: "delete-addon-modal-question" },
        "Are you sure you want to remove ",
        React.createElement(
          "span",
          { className: "addon-to-remove" },
          this.props.data.name
        ),
        " as an add-on?"
      )
  ...
  displayName: "DeleteAppModal",

  render: function () {
    return React.createElement(
      "div",
      { className: "delete-app-modal-container" },
      React.createElement(
        "div",
        { className: "delete-app-modal-question" },
        "Are you sure you want to delete this app?"
      )
    );
  }
});var DeletePipelineModal = React.createClass({
  displayName: "DeletePipelineModal",

  render: function () {
    return React.createElement(
      "div",
      { className: "delete-pipeline-modal-container" },
      React.createElement(
        "div",
        { className: "delete-pipeline-modal-question" },
        "Are you sure you want to delete this pipeline?"
      )
    );
  }
});var DeleteTeamModal = React.createClass({
  displayName: "DeleteTeamModal",

  render: function () {
    return React.createElement(
      "div",
      { className: "delete-team-modal-container" },
      React.createElement(
        "div",
        { className: "delete-team-modal-question" },
        "Are you sure you want to delete this team?"
      )
    );
  }
});var DeleteTeamUserModal = React.createClass({
  displayName: "DeleteTeamUserModal",

  render: function () {
    return React.createElement(
      "div",
      { className: "delete-team-user-modal-container" },
      React.createElement(
        "div",
        { className: "delete-team-user-modal-question" },
        "Are you sure you want to remove ",
        React.createElement(
          "span",
          { className: "email-to-remove" },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'modal-name-input-container', ref: this.setInputContainerRef },
        React.createElement('input', { type: 'text', className: 'modal-name-input', placeholder: 'Your email', onKeyUp: this.onKeyUp, ref: this.setInputRef })
      )
    );
  }

});var KeyDeleteModal = React.createClass({
  displayName: "KeyDeleteModal",

  render: function () {
    return React.createElement(
      "div",
      { className: "key-delete-modal-body" },
      React.createElement(
        "div",
        { className: "modal-question-text" },
        "Are you sure you want to remove the following config var?"
      ),
      React.createElement(
        "div",
        { className: "config-var-to-remove" },
        this.props.data.name
      )
    );
  }
});var KeyUpdateModal = React.createClass({
  displayName: 'KeyUpdateModal',
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'key-update-modal-body' },
      React.createElement(ModalTitledInput, { titleText: 'Key', defaultValue: this.props.data.name, ref: this.setKeyNameRef }),
      React.createElement(ModalTitledInput, { titleText: 'Value', defaultValue: this.props.data.value, ref: this.setKeyValueRef }),
      React.createElement(ModalTitledInput, { titleText: 'Description', defaultValue: this.props.data.description, ref: this.setDescriptionRef })
    );
  }
});var ModalNameInput = React.createClass({
  displayName: 'ModalNameInput',
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'modal-name-input-container' },
      React.createElement('i', { className: 'fa fa-check-circle name-available-indicator-icon available' }),
      React.createElement('i', { className: 'fa fa-ban name-available-indicator-icon not-available' }),
      React.createElement('input', { type: 'text', className: 'modal-name-input', placeholder: this.props.placeholder, defaultValue: this.getDefaultValue(), ref: this.setInputRef })
    );
  }
});var ModalSelect = React.createClass({
  displayName: "ModalSelect",
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "select",
        { key: Date.now(), ref: this.setSelectRef, className: "conflux-select", defaultValue: this.getDefault(), onChange: this.onSelectChange },
        this.getSelectOptions()
      )
    );
  }
});var ModalSelectionAttributes = React.createClass({
  displayName: 'ModalSelectionAttributes',
  ...
  getFeatures: function () {
    ...
    return this.props.data.headline_features.map(function (feature) {
      ...
      if (value === 'yes') {
        value = React.createElement('i', { className: 'fa fa-check yes' });
      } else if (value === 'no') {
        value = React.createElement('i', { className: 'fa fa-times no' });
      }
  ...
  render: function () {
    return React.createElement(
      'div',
      { key: Date.now(), className: 'modal-selection-attrs' },
      this.getFeatures()
    );
  }
});var ModalTitledInput = React.createClass({
  displayName: 'ModalTitledInput',
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'modal-titled-input-container', ref: this.setInputContainerRef },
      React.createElement(
        'div',
        { className: 'select-title' },
        this.props.titleText
      ),
      React.createElement('input', { key: Date.now(), type: 'text', className: 'modal-titled-input', onKeyUp: this.onKeyUp, placeholder: this.props.placeholder, defaultValue: this.getDefaultValue(), ref: this.setInputRef })
    );
  }
  ...
  getCurrentModal: function () {
    return ({
      'team:create': {
        body: React.createElement(UpsertTeamModal, { data: this.data, isNew: true, ref: this.setCurrentModal }),
        confirmText: 'Create',
        headerText: 'New Team'
      },
      'team:update': {
        body: React.createElement(UpsertTeamModal, { data: this.data, isNew: false, ref: this.setCurrentModal }),
        confirmText: 'Save',
        headerText: 'Edit Team'
      },
      'team:delete': {
        body: React.createElement(DeleteTeamModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Yes, delete it.',
        declineText: 'No',
        headerText: 'Delete Team'
      },
      'pipeline:create': {
        body: React.createElement(UpsertPipelineModal, { data: this.data, isNew: true, ref: this.setCurrentModal }),
        confirmText: 'Create',
        headerText: 'New Pipeline'
      },
      'pipeline:update': {
        body: React.createElement(UpsertPipelineModal, { data: this.data, isNew: false, ref: this.setCurrentModal }),
        confirmText: 'Save',
        headerText: 'Edit Pipeline'
      },
      'pipeline:delete': {
        body: React.createElement(DeletePipelineModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Yes, delete it.',
        declineText: 'No',
        headerText: 'Delete Pipeline'
      },
      'app:create': {
        body: React.createElement(UpsertAppModal, { data: this.data, isNew: true, ref: this.setCurrentModal }),
        confirmText: 'Create',
        headerText: 'New App'
      },
      'app:update': {
        body: React.createElement(UpsertAppModal, { data: this.data, isNew: false, ref: this.setCurrentModal }),
        confirmText: 'Save',
        headerText: 'Edit App'
      },
      'app:delete': {
        body: React.createElement(DeleteAppModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Yes, delete it.',
        declineText: 'No',
        headerText: 'Delete App'
      },
      'addon:create': {
        body: React.createElement(UpsertAddonModal, { data: this.data, isNew: true, ref: this.setCurrentModal }),
        confirmText: 'Provision'
      },
      'addon:update': {
        body: React.createElement(UpsertAddonModal, { data: this.data, isNew: false, ref: this.setCurrentModal }),
        confirmText: 'Update'
      },
      'addon:delete': {
        body: React.createElement(DeleteAddonModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Yes, remove it.',
        declineText: 'No',
        headerText: 'Remove Add-on'
      },
      'key:update': {
        body: React.createElement(KeyUpdateModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Save',
        headerText: 'Edit Config Var'
      },
      'key:delete': {
        body: React.createElement(KeyDeleteModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Yes, remove it.',
        declineText: 'No',
        headerText: 'Delete Config Var'
      },
      'users:invite': {
        body: React.createElement(UpsertTeamUserModal, { data: this.data, isNew: true, ref: this.setCurrentModal }),
        confirmText: 'Send invitation',
        headerText: 'New Member'
      },
      'users:update': {
        body: React.createElement(UpsertTeamUserModal, { data: this.data, isNew: false, ref: this.setCurrentModal }),
        confirmText: 'Save',
        headerText: 'Edit Team Member'
      },
      'users:delete': {
        body: React.createElement(DeleteTeamUserModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Yes',
        declineText: 'No',
        headerText: 'Remove Team Member'
      },
      'feedback:create': {
        body: React.createElement(UserFeedbackModal, { data: this.data, ref: this.setCurrentModal }),
        confirmText: 'Submit',
        headerText: 'Give Feedback to Conflux'
      },
      'password:forgot': {
        body: React.createElement(ForgotPasswordModal, { data: this.data, ref: this.setCurrentModal }),
  ...
  getFooterButtons: function () {
    ...
    if (currentModal.confirmText && currentModal.declineText) {
      return React.createElement(
        'div',
        { className: 'double-footer-btns' },
        React.createElement(
          'a',
          { onClick: this.onDecline, className: 'modal-action-link', href: 'javascript:void(0)' },
          React.createElement(
            'div',
            { className: 'modal-action-btn decline' },
            this.getDeclineText()
          )
        ),
        React.createElement(
          'a',
          { onClick: this.onConfirm, className: 'modal-action-link', href: 'javascript:void(0)' },
          React.createElement(
            'div',
            { className: 'modal-action-btn confirm' },
            this.getConfirmText()
          ),
          React.createElement(HorizontalSpinner, { ref: this.setSpinnerRef })
        )
      );
    } else {
      return React.createElement(
  ...
  onPlanChange: function (val) {
    this.planDescription.updateAttrs(_.findIndex(this.props.data.plans, function (plan) {
      return plan.slug == val;
    }));
  },
  ...
  render: function () {
    ...
    if (_.isEmpty(this.props.data)) {
      ...
      return React.createElement(
        'div',
        null,
        React.createElement(AddonModalTop, { data: this.props.data }),
        React.createElement(ModalSelect, { onChange: this.onPlanChange, data: this.formatSelectData(), ref: function (ref) {
            self.planSelectComp = ref;
          } }),
        React.createElement(ModalSelectionAttributes, { data: this.getSelectionAttrData(), ref: function (ref) {
            self.planDescription = ref;
          } })
      );
    }
  }
});var UpsertAppModal = React.createClass({
  displayName: 'UpsertAppModal',
  ...
  formatSelectData: function () {
    return {
      title: 'Tier',
      selectedIndex: this.props.data.selectedIndex,
      options: this.tiers().map(function (tier) {
        return { text: tier, value: tier };
      })
    };
  },
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(ModalNameInput, { placeholder: 'App name', defaultName: this.props.data.defaultName, onKeyUp: this.onNameInputKeyUp, ref: this.setNameInputRef }),
      React.createElement(ModalSelect, { data: this.formatSelectData(), ref: function (ref) {
          self.tierSelectComp = ref;
        } })
    );
  }
});var UpsertPipelineModal = React.createClass({
  displayName: 'UpsertPipelineModal',
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'create-pipeline-modal-body' },
      React.createElement(ModalNameInput, { key: Date.now(), placeholder: 'Name', defaultName: (this.props.data || {}).name, onKeyUp: this.onNameInputKeyUp, ref: this.setNameInputRef }),
      React.createElement('textarea', { key: Date.now() + 1, className: 'modal-add-description', defaultValue: (this.props.data || {}).description, placeholder: 'Description (optional)' })
    );
  }
});var UpsertTeamModal = React.createClass({
  displayName: 'UpsertTeamModal',
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(ModalNameInput, { placeholder: 'Team name', defaultName: this.props.data.defaultName, onKeyUp: this.onNameInputKeyUp, ref: this.setNameInputRef })
    );
  }
});var UpsertTeamUserModal = React.createClass({
  displayName: 'UpsertTeamUserModal',
  ...
  headlineFeatures: ['Read/Write access to all Non-production apps', 'Read access to Production apps', 'Write access to Production apps', 'Can invite new team members'],
  ...
  getEmail: function () {
    if (this.props.isNew) {
      return React.createElement('input', { type: 'text', className: 'modal-name-input', placeholder: 'Email', onKeyUp: this.onKeyUp, ref: this.setInputRef });
    } else {
      return React.createElement(
        'div',
        { className: 'static-user-email' },
        this.props.data.email
      );
    }
  },
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: modalNameInputContainerClasses, ref: this.setInputContainerRef },
        this.getEmail()
      ),
      React.createElement(ModalSelect, { data: this.formatSelectData(), ref: this.setRoleRef, onChange: this.onRoleChange }),
      React.createElement(ModalSelectionAttributes, { data: this.getSelectionAttrData(), ref: this.setRoleDescriptionRef })
    );
  }

});var UserFeedbackModal = React.createClass({
  displayName: 'UserFeedbackModal',
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'modal-textarea-container', ref: this.setInputContainerRef },
        React.createElement('textarea', { className: 'modal-textarea', placeholder: 'Feedback, suggestions, bugs, etc.', onKeyUp: this.onKeyUp, ref: this.setInputRef })
      )
    );
  }

});var AppAddon = React.createClass({
  displayName: 'AppAddon',
  ...
  getSettingsIcon: function () {
    ...
    return React.createElement(
      ...
      React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/gear.png', id: 'settingsIcon' }),
      React.createElement(Dropdown, { customID: 'appAddonSettingsDropdown', data: this.getSettingsDropdownOptions(), ref: this.setDropdownRef })
    );
  },
  ...
  getAddonDescription: function () {
    if (this.props.write_access) {
      return React.createElement(
        ...
        React.createElement(
          'textarea',
          { className: 'description', autoComplete: 'off', autoCorrect: 'off', autoCapitalize: 'off', spellCheck: 'false', ref: this.setDescriptionRef },
      ...
      return React.createElement(
        'div',
        { className: 'app-addon-static-description-container' },
        React.createElement('div', { className: 'header-linebreak' }),
        React.createElement(
          'div',
          { className: 'static-app-addon-description' },
          this.props.description
        )
      );
    }
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'app-addon-header' },
        React.createElement(
          'div',
          { className: 'addon-primary-info' },
          React.createElement('img', { src: this.props.icon, className: 'icon' }),
          React.createElement(
            'div',
            { className: 'name' },
            this.props.name
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: this.getConfigVarsClasses() },
          React.createElement(ConfigVars, { data: this.props, writeAccess: this.props.write_access })
        ),
        React.createElement(
          'div',
          { className: 'plans-links-container' },
          React.createElement(
            'div',
            { className: 'plans-container' },
            React.createElement(Plans, { data: this.props.plan_data, writeAccess: this.props.write_access, onPlanSelected: this.onPlanSelected, ref: this.setPlanRef })
          ),
          React.createElement(
            'div',
  ...
  getSettingsIcon: function () {
    ...
    return React.createElement(
      ...
      { className: 'settings-icon-container' },
      React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/gear.png', id: 'settingsIcon' }),
      React.createElement(Dropdown, { customID: 'appSettingsDropdown', data: this.getSettingsDropdownOptions(), ref: this.setDropdownRef })
    );
  },
  ...
  render: function () {
    return React.createElement(
      ...
      { id: 'app' },
      this.getSettingsIcon(),
      React.createElement(AppHeader, { data: this.props, onCreateNewAddon: this.onCreateNewAddon, ref: this.setHeaderRef }),
      React.createElement(AddonGrid, { data: this.props, writeAccess: this.props.write_access, ref: this.setGridRef }),
      React.createElement(
        'div',
  ...
  getCategoryNames: function () {
    ...
    return (this.props.addons || []).map(function (group) {
      return React.createElement(
        'div',
        { className: 'category-name', onClick: self.scrollToCategory, 'data-category': group[0].toLowerCase() },
        group[0]
      );
    });
  },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'explore-subheader conflux-container' },
        React.createElement(
          'div',
          { className: 'title' },
          'Explore the Add-ons ready to integrate with your app.'
        ),
        React.createElement(
          'div',
          { className: 'subtitle' },
          'Add-ons are self-hosted, third-party services, ready to be integrated with your app in one command. They provide services for caching, persistence, email, messaging, and more.'
        )
      ),
      React.createElement(
        'div',
        { className: 'explore-body conflux-container' },
        React.createElement(
          'div',
          { id: 'categoriesList' },
          React.createElement(
        ...
        React.createElement(CategoryAddons, { data: this.props, ref: this.setCategoryAddonsRef })
      ),
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "title" },
          "Conflux Add-ons Platform & Marketplace"
        ),
        React.createElement(
          "div",
          { className: "subtitle" },
          "Manage all of your app's third-party services from one secure location, regardless of host platform or environment."
        ),
        React.createElement(
          "div",
          { className: "home-main-action-btn-container" },
          React.createElement(
            "a",
            { className: "home-main-action-btn", href: this.getStartedLink() },
            "Get Started"
          )
        )
      ),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "div",
                  { className: "feature" },
                  "Provision & configure add-ons in one command."
                ),
                React.createElement(
                  "div",
                  { className: "sub-text" },
                  "Conflux makes it possible to provision new add-ons in one simple command. ",
                  React.createElement(
                    "span",
                    { className: "highlight" },
                    "Further configuration — new libraries, config vars, or add-on specific files — is automatically taken care of"
                  ),
                  ", reducing setup time and allowing you to focus more on your product."
                )
              )
            ),
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "terminal-example", ref: this.setTerminalContainerRef },
                React.createElement("div", { className: "terminal-text", ref: this.setTerminalTextRef })
              )
            )
          )
        ),
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "sub-section" },
              React.createElement("img", { className: "image-section left", src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/platform-agnostic.png" })
            ),
            React.createElement(
              "div",
              { className: "sub-section" },
              React.createElement(
                ...
                React.createElement(
                  "div",
                  { className: "feature" },
                  "Access add-on bundles from any host platform."
                ),
                React.createElement(
                  "div",
                  { className: "sub-text" },
                  "Whether locally or in the cloud, where you host your app shouldn't matter when it comes to your third-party services. ",
                  React.createElement(
                    "span",
                    { className: "highlight" },
                    "Conflux add-ons are platform-agnostic."
                  ),
                  " So once they're provisioned, you can use them anywhere, making it possible to switch host providers without reconfiguring add-ons."
                )
              )
            )
          )
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "div",
                  { className: "feature" },
                  "Easily clone & scale add-ons across environments."
                ),
                React.createElement(
                  "div",
                  { className: "sub-text" },
                  "Spinning up a new dev environment shouldn't require you to manually configure a whole new set of add-ons. Conflux lets you ",
                  React.createElement(
                    "span",
                    { className: "highlight" },
                    "clone add-ons across environments with one click"
                  ),
                  ", with an easy means of scaling up along the way."
                )
              )
            ),
            React.createElement(
              "div",
              { className: "sub-section" },
              React.createElement("img", { className: "image-section right", src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/clone.png" })
            )
          )
        ),
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "sub-section" },
              React.createElement("img", { className: "image-section left", src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/onboard.png" })
            ),
            React.createElement(
              "div",
              { className: "sub-section" },
              React.createElement(
                ...
                React.createElement(
                  "div",
                  { className: "feature" },
                  "On-board new team members with one click."
                ),
                React.createElement(
                  "div",
                  { className: "sub-text" },
                  "Rather than managing your team members from each service's site, ",
                  React.createElement(
                    "span",
                    { className: "highlight" },
                    "manage them all in one place."
                  ),
                  " One invitation is all it takes to get new members up and running with the add-ons they need to start developing. ",
                  React.createElement(
                    "span",
                    { className: "new-section" },
                    "Custom user roles make it possible to ",
                    React.createElement(
                      "span",
                      { className: "highlight" },
                      "specify which add-ons each user has access to"
                    ),
                    " for better internal security."
                  )
                )
              )
            )
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "div",
                  { className: "feature" },
                  "Abstract out config management."
                ),
                React.createElement(
                  "div",
                  { className: "sub-text" },
                  "Forget about each developer having to maintain his own local copy of your integration configs in order for his app to work. Conflux ",
                  React.createElement(
                    "span",
                    { className: "highlight" },
                    "consolidates all of your add-ons' configs into one secure location"
                  ),
                  " that's always in sync with every developer on your team. ",
                  React.createElement(
                    "span",
                    { className: "new-section" },
                    "Existing configs won't ever go stale, ",
                    React.createElement(
                      "span",
                      { className: "highlight" },
                      "new add-on configs will be instantly available to other team members"
                    ),
                    ", and you won't have to worry about excess copies of configs floating around."
                  )
                )
              )
            ),
            React.createElement(
              "div",
              { className: "sub-section" },
              React.createElement("img", { className: "image-section right", src: "http://confluxapp.s3-website-us-west-1.amazonaws.com/images/abstract-configs.png" })
            )
          )
        ),
        React.createElement(
          "a",
          { href: "/toolbelt", className: "toolbelt-link" },
          React.createElement(
            "div",
            { className: "home-section get-toolbelt" },
            React.createElement(
              "div",
              { className: "get-toolbelt-text" },
              React.createElement("i", { className: "fa fa-terminal" }),
              " Get started with the open source ",
              React.createElement(
                "span",
                { className: "toolbelt-text" },
                "Conflux Toolbelt"
              ),
              "."
            )
  ...
  getNameInput: function () {
    return this.state.sign_up ? React.createElement('input', { type: 'text', name: 'name', className: 'card-input', placeholder: 'name (optional)', ref: this.setNameRef }) : null;
  },

  getConfirmPassword: function () {
    return this.state.sign_up ? React.createElement('input', { type: 'password', name: 'confirm-password', className: 'card-input required', placeholder: 'confirm password', ref: this.setConfirmPasswordRef }) : null;
  },
  ...
  getSubtitle: function () {
    return this.state.sign_up ? null : React.createElement(
      'div',
      { className: 'subtitle' },
      'Enter your ',
      React.createElement(
  ...
  getFooterButtons: function () {
    ...
    return btnInfo.map(function (info) {
      return React.createElement(
        ...
        React.createElement(
          'a',
          { href: info.link, onClick: info.onClick || function () {}, className: 'card-footer-link' },
          info.text
        )
      );
    });
  ...
  getPrimaryBtnText: function () {
    return this.state.sign_up ? React.createElement(
      'span',
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'card-body' },
          React.createElement('input', { type: 'text', name: 'email', className: 'card-input required', placeholder: 'email', ref: this.setEmailRef }),
          React.createElement('input', { type: 'password', name: 'password', className: 'card-input required', placeholder: 'password', ref: this.setPasswordRef }),
          this.getConfirmPassword(),
          React.createElement(
            'a',
            { className: 'primary-action-btn', onClick: this.onLoginClick, href: 'javascript:void(0)' },
  ...
  getNewPipelineBtn: function () {
    ...
    return React.createElement(
      "div",
      { onClick: this.onNewPipelineClick, className: "new-pipeline-btn" },
      "New Pipeline  ",
      React.createElement(
        "span",
        { className: "plus" },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "message" },
        "Your team currently doesn't have any pipelines."
      ),
      this.getNewPipelineBtn()
    );
  }
});var PageDNE = React.createClass({
  displayName: "PageDNE",
  ...
  formatTiers: function () {
    ...
    return this.props.tiers.reverse().map(function (tier) {
      return React.createElement(
        'li',
        null,
        React.createElement(Tier, { tierUUIDs: self.tierUUIDs, productionTierUUID: self.productionTierUUID, data: tier, hideProd: tier.stage == self.productionTier && !self.props.show_prod_apps, preventNewAppsForTier: tier.stage == self.productionTier && !self.props.can_write_prod_apps, canCreateNewProdApps: self.props.can_write_prod_apps, ref: self.addTierToTiersMap })
      );
    });
  },
  ...
  getSettingsIcon: function () {
    ...
    return React.createElement(
      ...
      { className: 'settings-icon-container' },
      React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/gear.png', id: 'settingsIcon' }),
      React.createElement(Dropdown, { customID: 'pipelineSettingsDropdown', data: this.getSettingsDropdownOptions(), ref: this.setDropdownRef })
    );
  },
  ...
  render: function () {
    return React.createElement(
      ...
      { id: 'pipeline' },
      this.getSettingsIcon(),
      React.createElement(PipelineHeader, { tierUUIDs: this.tierUUIDs, productionTierUUID: this.productionTierUUID, data: this.props, onNewAppCreated: this.newAppCreated, canCreateNewProdApps: this.props.can_write_prod_apps, ref: this.setHeaderRef }),
      React.createElement(
        'ul',
        { id: 'tiersList' },
        this.formatTiers()
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          { className: 'card-body' },
          React.createElement('input', { type: 'text', name: 'email', className: 'card-input required', placeholder: 'email', ref: this.setEmailRef }),
          React.createElement('input', { type: 'password', name: 'current-password', className: 'card-input required', placeholder: 'current password', ref: this.setPasswordRef }),
          React.createElement('input', { type: 'password', name: 'new-password', className: 'card-input required', placeholder: 'new password', ref: this.setNewPasswordRef }),
          React.createElement('input', { type: 'password', name: 'confirm-new-password', className: 'card-input required', placeholder: 'confirm new password', ref: this.setConfirmNewPasswordRef }),
          React.createElement(
            'a',
            { className: 'primary-action-btn', onClick: this.onResetClick, href: 'javascript:void(0)' },
            React.createElement(
              'span',
              { className: 'primary-text' },
              'Reset'
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'toolbelt-subheader conflux-container' },
        React.createElement(
          'div',
          { className: 'title' },
          'Conflux Toolbelt'
        ...
        React.createElement(
          'div',
          { className: 'subtitle' },
          'Get up and running with Conflux by downloading the developer toolbelt. Connect to your add-ons, add new team members, and much more, straight from the command line. Follow the guide below to get started, or ',
          React.createElement(
            'a',
            { href: 'https://github.com/GoConflux/conflux-cli', target: '_blank' },
      ...
      React.createElement(
        'div',
        { className: 'toolbelt-body conflux-container' },
        React.createElement(
          'div',
          { className: 'before-getting-started md-text' },
          'Before getting started, make sure you have a Conflux account. If you haven\'t signed up yet, ',
          React.createElement(
            'a',
            { href: '/signup' },
            'create an account'
          ...
          React.createElement(
            'span',
            { className: 'feaux-link', onClick: this.scrollToSupportSection },
            'make sure your operating system and app\'s language are supported.'
          )
        ),
        React.createElement(
          'div',
          { className: 'conflux-md-numbered-section' },
          React.createElement(
            'div',
            { className: 'numbered-title' },
            '1. Installing the Toolbelt'
          ),
          React.createElement(
            'div',
            { className: 'md-section-description' },
            React.createElement(
              'div',
              { className: 'md-text' },
              'Download and install the toolbelt by running the following command in your command shell:'
            ),
            React.createElement(
              'div',
              { className: 'md-shell' },
              ...
              React.createElement(
                'span',
                { className: 'command' },
                'wget -O- http://goconflux.com/install.sh | sh'
              )
            )
          )
        ),
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              ' command from your command shell (Note: type ',
              React.createElement(
                'span',
                { className: 'md-shell' },
                'conflux help'
              ),
              ' at any time to see a list of available commands).'
            ),
            React.createElement(
              'div',
              { className: 'md-text' },
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'numbered-title' },
            '3. Connecting your project to a Conflux app'
          ),
          React.createElement(
            'div',
            { className: 'md-section-description' },
            React.createElement(
              'div',
              { className: 'md-text' },
              'If you haven\'t created a Conflux team yet, go ahead and ',
              React.createElement(
                'span',
                { className: 'feaux-link', onClick: this.promptNewTeam },
                'create a new team'
              ),
              '. Your team should come pre-configured with a local Conflux app — a group of conflux add-ons mapping to a specific environment.'
            ),
            React.createElement(
              'div',
              { className: 'sub-section' },
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'md-text' },
                  'To establish which Conflux app to use for a local project, run ',
                  React.createElement(
                    'span',
                    { className: 'md-shell' },
                    'conflux init'
                  ),
                  ' from inside that project\'s root directory and choose the app you wish to use:'
                ),
                React.createElement(
                  'div',
                  { className: 'md-shell' },
                ...
                React.createElement(
                  'div',
                  { className: 'md-text' },
                  'Once this connection is established, run ',
                  React.createElement(
                    'span',
                    { className: 'md-shell' },
                    'conflux pull'
                  ),
                  ' to check if any jobs need to be run to finish configuring your add-ons:'
                ),
                React.createElement(
                  'div',
                  { className: 'md-shell' },
                  ...
                  React.createElement('br', null),
                  'Creating file: config/initializers/redis.rb',
                  React.createElement('br', null),
                  'Done.',
                  React.createElement('br', null)
                ),
                React.createElement(
                  'div',
                  { className: 'md-text' },
                  'At this point, you can view the ',
                  React.createElement(
                    'span',
                    { className: 'md-shell' },
                    '.conflux/conflux.yml'
                  ),
                  ' file inside your project\'s root directory to see which configs will be available when you boot your server. For example:'
                ),
                React.createElement(
                  'div',
                  { className: 'md-shell' },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'md-text' },
                  'Instead of relying on the toolbelt to establish a Conflux connection on a remote server, you can utilize a rake task built into the ',
                  React.createElement(
                    'a',
                    { href: 'https://github.com/GoConflux/conflux-rb', target: '_blank' },
                    'Conflux ruby gem'
                  ),
                  ' to do just that:'
                ),
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'command' },
                    'bundle exec rake conflux:set_app'
                  ),
                  React.createElement('br', null),
                  'Email: ben@example.com',
                  React.createElement('br', null),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'md-text' },
                  'Connecting a Heroku app to a Conflux app can be done in just one command:'
                ),
                React.createElement(
                  'div',
                  { className: 'md-shell' },
                  ...
                  React.createElement(
                    'span',
                    { className: 'command' },
                    'conflux apps:heroku_use my-conflux-app -a my-heroku-app'
                  ),
                  React.createElement('br', null),
                  ...
                  React.createElement('br', null),
                  'Successfully connected Heroku app \'my-heroku-app\' to conflux app \'my-conflux-app\'.',
                  React.createElement('br', null)
                )
              )
            )
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { className: 'md-text' },
              'Once your project is connected to the Conflux app of your choice, your add-ons will automatically be made available any time you start up your server. This way, you can stop worrying about setup and get back to building out your app. Enjoy your add-ons!'
            )
          )
        )
      ),
      React.createElement(
        'div',
        { className: 'toolbelt-support', ref: this.setSupportSectionRef },
        React.createElement(
          'div',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'Mac OS X, Linux, (Windows coming soon)'
            ),
            React.createElement(
              'div',
              { className: 'support-section' },
  ...
  getDescription: function () {
    return this.state.description ? this.state.description : React.createElement(
      'span',
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'pipeline-header-left' },
        React.createElement('img', { src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/pipeline-dark.svg', className: 'pipeline-icon' }),
        React.createElement(
          'div',
          { className: 'pipeline-name' },
          this.state.name
      ...
      React.createElement(
        'div',
        { className: 'pipeline-header-right' },
        React.createElement(
          'div',
          { onClick: this.onNewAppClick, className: 'new-app-btn' },
          'New App  ',
          React.createElement(
            'span',
            { className: 'plus' },
      ...
      $('.autocomplete-input').selectize({
        ...
        render: {
          option: function (item) {
            return '<div class="addon-search-result" data-value="' + item.value + '">' + '<img class="sr-icon" src="' + item.icon + '" />' + '<span class="sr-name">' + item.text + '</span>' + '</div>';
          }
        }
      });
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'in-app-search-bar', ref: this.setSearchBarRef },
      React.createElement('img', { className: 'search-icon', src: 'http://confluxapp.s3-website-us-west-1.amazonaws.com/images/search.png' }),
      React.createElement('input', { type: 'text', className: 'autocomplete-input', placeholder: 'Find add-ons to add' })
    );
  }
});var NoAppsForTier = React.createClass({
  displayName: 'NoAppsForTier',
  ...
  getText: function () {
    if (this.props.preventNewAppsForTier) {
      return React.createElement(
        'span',
        null,
        'No apps exist yet for this tier.'
      );
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        'span',
        { onClick: this.showAddNewApp, className: 'add-first-app-to-tier' },
        'Click to add one.'
      )
    );
  },
  ...
  formatApps: function () {
    if (this.props.hideProd) {
      return React.createElement(
        ...
        React.createElement(
          "div",
          { className: "pipeline-view-apps-off-limits" },
          "You currently don't have access to production apps."
        )
      );
    }
    ...
    if (this.state.apps.length == 0) {
      return React.createElement(
        "li",
        { className: "none" },
        React.createElement(NoAppsForTier, { productionTierUUID: this.props.productionTierUUID, canCreateNewProdApps: this.props.canCreateNewProdApps, preventNewAppsForTier: this.props.preventNewAppsForTier, onNewAppCreated: this.newAppCreated, tierUUIDs: this.props.tierUUIDs, stage: this.props.data.stage })
      );
    }
    ...
    return this.state.apps.map(function (app) {
      return React.createElement(
        ...
        React.createElement(
          "li",
          null,
          React.createElement(AppListItem, { data: app })
        )
      );
    });
  },
  ...
  getUserPic: function () {
    ...
    return React.createElement('img', { src: src, className: classes });
  },
  ...
  getActionIcons: function () {
    ...
    return React.createElement(
      'div',
      { className: 'team-user-action-icons' },
      React.createElement('i', { className: 'fa fa-pencil edit', onClick: this.onEditUser }),
      React.createElement('i', { className: 'fa fa-times remove', onClick: this.onRemoveUser })
    );
  },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'team-user-label' },
        this.getAdminOrOwnerLabel()
      )
    );
  }
});var TeamUsersList = React.createClass({
  displayName: "TeamUsersList",
  ...
  getUsers: function () {
    ...
    return this.state.users.map(function (user) {
      return React.createElement(
        "li",
        null,
        React.createElement(TeamUser, { data: user, cuCanEdit: self.props.cuCanEdit, updateUsersList: self.props.updateUsersList })
      );
    });
  },
  ...
  getAddMembersBtn: function () {
    if (this.props.cu_can_invite) {
      return React.createElement(
        'div',
        { className: 'add-members-btn', onClick: this.showAddMembersModal },
        React.createElement(
          'span',
          { className: 'text' },
          'New Member'
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'team-users-header-left' },
          React.createElement(
            'div',
            { className: 'left-header-title' },
            this.getHeader()
      ...
      React.createElement(TeamUsersList, { users: this.props.users, cuCanEdit: this.props.cu_can_edit, updateUsersList: this.updateUsersList, ref: this.setTeamUsersListRef })
    );
  }
  ...
  getDropdownOptions: function () {
    ...
    return this.props.data.map(function (option) {
      return React.createElement(
        'li',
        { className: 'dropdown-option', onClick: option.onClick },
        React.createElement(
          'div',
          { className: 'text' },
          option.text
        ),
        React.createElement('i', { className: option.iconClasses })
      );
    });
  },
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'dropdown-container', id: this.props.customID },
      React.createElement(
        'ul',
  ...
  render: function () {
    return React.createElement(
      "div",
      { className: "horiz-spinner", ref: this.setSpinnerRef },
