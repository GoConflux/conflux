...
var AddonGrid = React.createClass({
  ...
  formatPipelines: function () {
    return this.state.pipelines.map(function (pipeline) {
      ...
      return React.createElement(
        ...
        React.createElement(
          'li',
          { key: pipeline.name, onClick: this.handlePipelineClick, className: 'menu-pipeline' },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement('input', { type: 'text', className: 'autocomplete-input', placeholder: 'Find other add-ons to add' })
    );
  }
