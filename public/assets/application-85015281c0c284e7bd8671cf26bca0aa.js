...
var AddonGrid = React.createClass({
  ...
  formatAddons: function () {
    if (this.state.addons.length == 0) {
      return React.createElement(
        ...
        "Use the search above to find and add some."
      );
    } else {
  ...
  getSearchBar: function () {
    if (this.props.data.can_add_new_addons) {
      ...
      return React.createElement(
        ...
        this.props.data.addons.length + ' add-ons'
      );
    }
  },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(AddonGrid, { data: this.props, ref: this.setGridRef }),
      React.createElement(
        'div',
  ...
  formatTiers: function () {
    ...
    return this.props.tiers.reverse().map(function (tier) {
      return React.createElement(
        'li',
        null,
        React.createElement(Tier, { tierUUIDs: self.tierUUIDs, data: tier, hideProd: tier.stage == self.productionTier && !self.props.show_prod_apps, ref: self.addTierToTiersMap })
      );
    });
  },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(PipelineHeader, { tierUUIDs: this.tierUUIDs, data: this.props, onNewAppCreated: this.newAppCreated, ref: this.setHeaderRef }),
      React.createElement(
        'ul',
        { id: 'tiersList' },
        this.formatTiers()
  ...
  formatApps: function () {
    ...
    if (this.state.apps.length == 0) {
      return React.createElement(
        "li",
        { className: "none" },
        React.createElement(NoAppsForTier, { onNewAppCreated: this.newAppCreated, tierUUIDs: this.props.tierUUIDs, stage: this.props.data.stage })
      );
    }
