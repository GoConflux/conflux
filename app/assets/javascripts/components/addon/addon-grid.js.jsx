  ...
  formatAddons: function () {
    if (this.state.addons.length == 0) {
      return this.props.writeAccess ?
        <div className="no-addons-view">This bundle doesn't have any add-ons yet.<br />Use the search above to add some.</div> :
        <div className="no-addons-view">This bundle doesn't have any add-ons yet.</div>;
    } else {
